...
registra(Tabela(
    ...
    rotulo_indice="fonte",
    colunas=[
        Coluna("dia_domingo_2023", "domingo 2023 (média/dia)", 0),
        Coluna("dia_domingo_2024", "domingo 2024 (média/dia)", 0),
        Coluna("dia_util_2023", "útil 2023 (média/dia)", 0),
        Coluna("dia_util_2024", "útil 2024 (média/dia)", 0),
